    ...
    if (renderUnity) {
      unityElement = (
        <UnityView
          ...
          onUnityMessage={this.onUnityMessage.bind(this)}></UnityView>
      );
    }
    ...
    return (
      <View style={[styles.container]}>
        ...
        <Text style={{ color: "black", fontSize: 15 }}>
          ...
          <Text style={{ color: "red" }}>{clickCount}</Text>{" "}
        </Text>
        <Button
          label='Toggle Unity'
          style={styles.button}
        ...
        {renderUnity ? (
          <Button
            label={unityPaused ? "Resume" : "Pause"}
            style={styles.button}
            onPress={this.onPauseAndResumeUnity.bind(this)}
          />
        ) : null}
      </View>
    );
